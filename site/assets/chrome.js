...
(function () {
  ...
  ensureMeta("mcfly-version", "v43");
  ensureMeta("mcfly-build", "rebuild-first-screen-v43");
  ...
  if (footer) {
    footer.innerHTML =
      ...
      "</nav>" +
      '<p class="fine">© <span data-year></span> Mcfly Ads. Mcfly Analytics — spend next to Shopify sales. 7 days, then $39. Trial and paid both keep the full desk.</p>' +
      "</div>" +
      "</footer>";
  }
