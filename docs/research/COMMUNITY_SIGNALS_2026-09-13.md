...
- Spot-check / reconcile prefer **ShopifyQL Analytics day totals** (fallback: order crawl)  
...
- Backfill missing days via ShopifyQL batch (faster + same grain)  
- Surface Total vs Net basis switch with one calm sentence on Sales  
