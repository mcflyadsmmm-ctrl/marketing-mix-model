...
| 2026-09-13 | **BC base restored:** Overview is home again (Black Clover scoreboard). Nav = Overview · Sales · Customers · Goals · Marketing Spend · Settings. Shopify depth desks improve on BC; Days/Orders/Cohorts ledgers next. See `docs/BC_BASE_PARITY.md`. |
| 2026-09-14 | **Skeleton in full:** shared DeskSection chrome; Sales/Customers sectioned (not flat grids); Days · Orders under Sales subnav; Cohorts under Customers (BC-tight top bar); Upload Spend stays entry-only. |
| 2026-09-13 | **Spend split:** top nav **Upload Spend** (entry only) + **Allocation** (own tab). Spend insights stays on subnav. Mirrors BC ritual vs readout. |
