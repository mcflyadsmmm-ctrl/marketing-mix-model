...
**Tip Fly note:** v439 / PR #191 / image `deployment-01M35JKWR3QY36FMAQ0QW0D6W0` / fly.toml still SAMPLE-only parked. Health ok 2026-09-22T22:09Z. Parks `/lab` + Custom. Pages **v36** Direct Upload `8ddad52e` live on mcflyads.com. fly.dev `/` **v36**. Cloud Agent Pages Edit proved.

| Metric | Status |
|--------|--------|
| Tip Fly SoT | v439 / PR #191 / fly.toml Live PARKED |
| SAMPLE smoke | WAIVED |
...
| Site P0 on box | DONE — mcflyads.com **v36** Pages `8ddad52e`; fly.dev `/` **v36** on Fly 439 |
| Money prep | Listing paste #192; Pages live v36 `8ddad52e`; tip Fly v439 / PR #191; fly.toml Live PARKED; Cloudflare Pages Edit connected |
