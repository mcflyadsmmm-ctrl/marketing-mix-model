...
**Pricing:** Shopify App Pricing — **one plan**: 7-day trial, then **$39/store/mo**, flat, for the whole desk. Not a GMV tax. **Product:** depth Shopify Analytics skips first—Overview YoY (this month / quarter / year vs last year), typical order, Customers / Growth / Orders / LTV. Spend is optional typed/CSV plus certified Total ROAS chips (honest MER: sales ÷ entered spend) and Channel Allocation. Empty spend is an em dash, not 0×. Never pixels / MTA / “true ROAS” / Profit Agent / P&L as hero. Trial and paid share the full desk and up to 24 months of orders. Uninstall stops the next cycle. A period already paid may run to its end. Admin is **Live-only**; SAMPLE is on https://mcflyads.com/demo only.
