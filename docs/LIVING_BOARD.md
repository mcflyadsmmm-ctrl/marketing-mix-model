...
| Field | Value |
| --- | --- |
| **Updated** | 2026-09-22 · America/Denver · Site **v45** Pages `8aef9cfb` · Fly **449** · SHA `014300d` · occupancy **0/4** · ads **NO** |
...
| **Fly** | https://mcfly-analytics.fly.dev · version **449** · image `deployment-01M365K3S52G81V6Q760B1CGVY` · craft Overview · `/health` 200 · marketing 301 → mcflyads.com · SAMPLE_ONLY **true** · scopes no `read_reports` |
