...
| Field | Value |
| --- | --- |
| **Updated** | 2026-09-22 · America/Denver · Site **v45** Pages `8aef9cfb` · Fly **452** · SHA `b8e8ef5` · occupancy **0/4** · ads **NO** |
...
| **Fly** | https://mcfly-analytics.fly.dev · version **452** · image `deployment-01M3679GCQM88KERJVQN2T3SJA` · Spend craft · `/health` 200 · marketing 301 → mcflyads.com · SAMPLE_ONLY **true** · scopes no `read_reports` |
