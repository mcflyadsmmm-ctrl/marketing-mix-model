...
2. Spend three doors: **Add spend**; **Paste a file**; **Fill many days**. Add Billboard + $400 + One day + yesterday, confirm the preview says $400/day, then click **Save Billboard $400 for [date]** once.
